...
with open ("brief-template.tex", "r") as letterfile:
    dummyletter=Template(letterfile.read())
with open ("fromaddressnew-template.lco", "r") as layoutfile:
...
with open('../brief.tex', 'w', encoding='latin1') as out0:
...
with open('../macros/fromaddressnew.lco', 'w', encoding='latin1') as out1:
